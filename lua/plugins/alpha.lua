...
return {
    ...
    config = function()
        ...
        -- 固定加载 header
        local header = require("assets.alpha.eva") -- 图片数据在 lua/assets/alpha/ 下
